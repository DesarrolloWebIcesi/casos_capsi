<?php
    ...
    if ( isset ( $_SERVER['SCRIPT_NAME'] ) ) {
        ...
        $t_host = '';
        $t_protocol = '';
        $t_url = 'http://www.icesi.edu.co/casos_capsi';
    }
...
$g_view_issues_page_columns = array ( 'selection', 'edit', /*'priority',*/ 'id', /*'bugnotes_count',*/ /*'severity',*/ 'status', 'handler_id', 'last_updated', 'summary', 'custom_Tipo', 'custom_Nombre y apellidos del solicitante', 'custom_Fecha en que debe regresar el usuario' /*'date_submitted'*/ );
// Columnas a imprimir
$g_print_issues_page_columns = array ( 'selection', /*'priority',*/ 'id', /*'severity',*/ 'status', 'last_updated', 'summary', 'date_submitted' );
...
$g_excel_columns = array ( 'id', 'project_id', 'reporter_id', 'handler_id', /*'priority', 'severity',*/ 'date_submitted', 'last_updated', 'summary', 'status' );
...
// Valor por defecto para la Importancia
...
// Url de la wiki
$g_wiki_engine_url = 'http://www.icesi.edu.co/wiki/';
...
$g_debug_timer = OFF;
// Correo de pruebas
$g_debug_email = 'jaescobar@icesi.edu.co';
$g_debug_email = OFF;
