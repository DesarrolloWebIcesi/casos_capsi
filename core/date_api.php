 ...
 * @access public
	Cambios
	iljojoa 	2014-12-17   calendario en español, se cambio la línea "html_javascript_link( 'jscalendar/lang/calendar-en.js' )"
 */
...
function date_print_calendar($p_button_name = 'trigger') {
	...
	if ((ON == config_get ( 'dhtml_filters' )) && (ON == config_get ( 'use_javascript' ))) {
		...
		/*
		 * $t_icon_path = config_get( 'icon_path' ); $t_cal_icon = $t_icon_path . "calendar-img.gif"; echo "<input type=\"image\" class=\"button\" id=\"" . $p_button_name . "\" src=\"" . $t_cal_icon . "\" />";
		 */
	}
}
